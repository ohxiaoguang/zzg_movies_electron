export const IPC_CHANNELS = {
  ...
  sourcesTransfer: 'sources:transfer',
  sourcesTransferHistory: 'sources:transfer-history',
  sourcesTransferCorrect: 'sources:transfer-correct',
