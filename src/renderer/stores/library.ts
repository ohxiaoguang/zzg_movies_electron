...
export const useLibraryStore = defineStore('library', () => {
  ...
  const filters = reactive<FilmPageQuery>({ page: 1, pageSize: DEFAULT_SETTINGS.pageSize, sort: 'added', organizationState: 'all', categoryIds: [], categoryMatch: 'any', nfoTagIds: [], nfoTagMatch: 'any', commentImages: 'all', allData: false, availability: 'all' });
  ...
  function resetFilters(): void {
    Object.assign(filters, { page: 1, pageSize: settings.value.pageSize, search: '', sourceId: '', actor: '', organizationState: 'all', categoryIds: [], categoryMatch: 'any', nfoTagIds: [], nfoTagMatch: 'any', minRating: undefined, favoriteOnly: false, commentImages: 'all', missingOnly: false, recordIssue: undefined, playbackCompatibility: undefined, allData: false, availability: 'all', sort: 'added' });
  }
