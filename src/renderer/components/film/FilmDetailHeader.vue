...
<template>
  <header class="detail-sticky-header">
    ...
    <div class="header-content">
      ...
      <div class="header-actions"><el-button type="primary" size="small" @click="emit('play')">播放原片</el-button><el-button size="small" @click="emit('showFolder')">打开目录</el-button><el-button size="small" :loading="rescanBusy" @click="emit('rescan')"><Refresh />重新扫描目录</el-button></div>
