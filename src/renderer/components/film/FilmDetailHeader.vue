...
<template>
  <header class="detail-sticky-header">
    ...
    <div class="header-content">
      ...
      <div class="header-actions"><el-button type="primary" size="small" @click="emit('play')">{{ detail.parts.length > 1 ? '选择分段播放' : '播放原片' }}</el-button><el-button size="small" @click="emit('showFolder')">打开目录</el-button></div>
